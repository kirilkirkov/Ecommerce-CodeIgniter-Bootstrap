                ...
                <hr>
                     <div class="list-group list-group">
                        ...
                        if ($categoiries->result()) {
                         ...
                         <a href="<?= base_url('admin/articles?category=shop') ?>" class="list-group-item"><span class="badge"><?=$num_shop_art?></span><span class="glyphicon glyphicon-shopping-cart"></span> Shop</a>
                    </div> 
                </div>
            </div>
            <div class="col-md-9">
                ...
                if ($articles->result()) {
                    foreach ($articles->result() as $row) {
                    	...
                    	if($row->image != null && file_exists($u_path.$row->image)) {
                    	 ...
                    	 //$row->thumb != null && file_exists('attachments/thumbs/' . $row->thumb) ? base_url('attachments/thumbs/' . $row->thumb) : 
