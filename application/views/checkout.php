...
?>
<hr>
<div class="alert alert-danger"><h4><span class="glyphicon glyphicon-alert"></span> <?= lang('finded_errors') ?></h4><?php foreach($this->session->flashdata('submit_error') as $error) echo $error.'<br>';?></div>
<hr>
<?php
}
?>
 ...
 <div class="col-sm-3"> 
 	 <div class="filter-sidebar">
                <div class="title">
					...
					<?php loop_articles($bestSellers, $currency, '', true); ?>
			  </div>
  </div>
  </div>
</div>
