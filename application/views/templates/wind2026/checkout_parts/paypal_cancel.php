...
<div class="mx-auto max-w-3xl px-4 py-14">
    <div class="rounded-3xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-200">
        <div class="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-900 text-white">
            <i class="fa fa-info" aria-hidden="true"></i>
        </div>
        <h1 class="mt-5 text-2xl font-bold tracking-tight text-slate-900">PayPal</h1>
        <p class="mt-2 text-sm text-slate-600"><?= lang('paypal_cancel_msg') ?></p>
