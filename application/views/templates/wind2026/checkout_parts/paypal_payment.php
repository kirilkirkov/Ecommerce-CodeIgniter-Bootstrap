    ...
    if (!empty($cartItems['array'])) {
        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
                <div class="paypal-image text-center py-6">
                    <span class="inline-flex items-center justify-center rounded-2xl bg-slate-900 px-5 py-3 text-xl font-bold text-white shadow-sm">
                        PayPal
                    </span>
                </div>
            </div>
